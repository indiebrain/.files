;;; indiebrain-recentf.el --- extensions to recentf.el for my Emacs configuration  -*- lexical-binding: t; -*-
...
;; Extensions to recentf.el. Intended to be used as part of my Emacs configuration.
;;
...
;;;###autoload
(defun indiebrain-recentf-recent-files-or-dirs (&optional arg)
  "Select recent file or, with ARG, recent directory."
  (interactive "P")
  (if arg
      (call-interactively 'indiebrain-recentf-recent-dirs)
    (call-interactively 'indiebrain-recentf-recent-files)))
