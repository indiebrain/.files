...
system login; IE a login after a system boot, or Secure Shell (SSH)
connection.
...
When a Bash shell is started as a non-login shell - IE any time a new
shell is created after login - it reads and executes the =.bashrc=
...
#+begin_src sh
export CDPATH=".:$HOME/Developer/personal/:$HOME/Developer/work/"
#+end_src
