  ...
  #+begin_src sh
    ...
    case "$TERM" in
        xterm*|rxvt*|screen*|eterm-color)
            ...
            GREY="\[$ESC[37;1m\]"
            LIGHT_RED="\[$ESC[31;2m\]"
            LIGHT_GREEN="\[$ESC[32;2m\]"
            LIGHT_YELLOW="\[$ESC[33;2m\]"
            LIGHT_BLUE="\[$ESC[34;2m\]"
            LIGHT_MAGENTA="\[$ESC[35;2m\]"
            LIGHT_CYAN="\[$ESC[36;2m\]"
            LIGHT_GREY="\[$ESC[37;2m\]"
            RESET="\[$ESC[0m\]"
        ;;
        ,*)
            ESC=""
    ...
    __git_count_str() {
        ...
        if [ 0 -lt "$ahead_count" ]; then
            str="${LIGHT_GREEN}+${ahead_count}${RESET}"
        fi
    ...
    __git_prompt() {
        ...
        if [ -n "$gitdir" ]; then
            ...
            branch="${LIGHT_GREY}${branch}${RESET}"
